...
public class DatumConstants {	
    ...
    //代理接口相关
    public static final String CODERBUSY_COUNTRY_URL = "https://proxy.coderbusy.com/classical/country/%s.aspx?page=%d";
    public static final String NNTIME_PROXY_URL = "http://nntime.com/proxy-list-%s.htm";
}
